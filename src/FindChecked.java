...
public class FindChecked implements Command{
    ...
    public void execute() {
        ...
        stream.filter(book -> user.equals(book.getBorrowedBy())).forEach(book ->{
            System.out.println("ID: "+book.getBookID()+" Author: "+book.getBookAuthor()+" Subject: "+book.getBookSubject());
        });
    }
